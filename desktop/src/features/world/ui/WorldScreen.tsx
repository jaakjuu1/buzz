...
/**
 * /world route surface. Mirrors PulseScreen's profile-panel pattern: clicking
 * a character opens the standard UserProfilePanel beside the world, and
 * clicking a room navigates to the real channel view.
 */
export function WorldScreen() {
  const identityQuery = useIdentityQuery();
  const { applyPatch, values } = useHistorySearchState(WORLD_PANEL_SEARCH_KEYS);
